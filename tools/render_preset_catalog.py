...
h1 {{ margin-bottom:.35rem }} .site-nav {{ display:flex; gap:1rem }} .site-nav a {{ color:#72d6a1; text-decoration:none; font-weight:700 }}
.summary {{ color:#aeb7c6 }} .controls {{ display:flex; gap:.75rem; flex-wrap:wrap; margin-top:1rem }}
